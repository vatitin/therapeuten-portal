...
@Injectable()
export class StatusTypeValidationPipe implements PipeTransform<string, StatusType | undefined> {
  ...
  transform(value: string | undefined): StatusType | undefined {
    ...
    if (!(value === StatusType.Active || value === StatusType.Waiting || value === StatusType.Inactive)) {
